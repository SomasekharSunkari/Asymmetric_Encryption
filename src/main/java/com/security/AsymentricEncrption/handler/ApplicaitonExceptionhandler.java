package com.security.AsymentricEncrption.handler;
...
import static com.security.AsymentricEncrption.enums.ErrorCode.*;
...
public class ApplicaitonExceptionhandler {
    ...
    public ResponseEntity<ErrorResponse> handleBusiness(final BussinessException ex){
        final ErrorResponse body = ErrorResponse.builder().code(ex.getErrorCode().getCode()).message(ex.getMessage()).build();
    ...
    public ResponseEntity<ErrorResponse> handleExecption(UsernameNotFoundException exception){
        log.debug(exception.getMessage(),exception);
        final ErrorResponse response = ErrorResponse.builder().code(USER_NOT_FOUND.getCode())
